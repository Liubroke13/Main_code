...
%           請先合併成一個PDF然後在這邊指定路徑。
% \makeAuthPage{1-Authorization/國立陽明交通大學--博碩士學位論文電子檔著作權授權書.pdf}  #here!!!!!!!!!!!!!

% 4. 博士論文指導教授推薦書(碩士論文免附)----電物系不用
...
%           請先合併成一個PDF然後在這邊指定路徑
% \makeApprovalPage{2-Approval/論文審定同意書_最終版.pdf}  #here!!!!!!!!!!!!!
...
\input{5-Chapters/2-Theory}
\input{5-Chapters/3-Result}
\input{5-Chapters/4-Conclusion}
...
% \input{7-Appendices/1-appendix}

%Publications
%\input{9-Publications/1-List}

% 17.發表型式確認書
\makeThesisFormatFormPage{11-ThesisFormatForm/發表型式確認書-最終版.pdf}
...
%           請先合併成一個PDF然後在這邊指定路徑
%       - 如果不需要，就請將這一行註解。
%\makeCoAuthorStatementPage{8-CoAuthor/著作彙編暨共同作者聲明書-最終版.pdf}
% 16. 封底
